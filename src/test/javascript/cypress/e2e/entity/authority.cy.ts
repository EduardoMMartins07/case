...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '98ac2126-113e-4a66-81e6-6e949ab4fb06' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('b5378c51-113d-4718-b3cf-aef74fde82b7');
      cy.get(`[data-cy="name"]`).should('have.value', 'b5378c51-113d-4718-b3cf-aef74fde82b7');
